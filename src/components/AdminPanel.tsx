  ...
  return (
    <div className="p-6 bg-white rounded-3xl border border-stone-200 shadow-sm">
      <div className="flex items-center gap-4 mb-8 border-b border-stone-100 pb-4">
        ...
        >
          Məhsul Təsdiqi ({sales.filter(s => s.status === 'pending').length})
        </button>
        <button 
                      ...
                      <div className="flex items-center justify-between text-xs text-stone-400">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {sale.status === 'pending' && (
                            <>
                              <button 
                                onClick={() => handleSaleAction(sale.id!, 'approved')}
                              ...
                              <button 
                                onClick={() => handleSaleAction(sale.id!, 'rejected')}
                                className="p-2 bg-red-500 text-white rounded-lg hover:bg-red-700 transition-all"
                                title="Rədd et"
                              >
                                <X size={16} />
                              </button>
